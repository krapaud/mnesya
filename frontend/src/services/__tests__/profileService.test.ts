 ...
 */
import { createProfile, getProfiles, getProfile, updateProfile, deleteProfile } from '../profileService';
...
describe('profileService', () => {
  ...
  describe('createProfile', () => {
    ...
    it('should throw on API error', async () => {
      ...
      await expect(createProfile({ first_name: 'A', last_name: 'B', birthday: '2000-01-01' }))
  ...
  describe('updateProfile', () => {
    it('should update and return the updated profile', async () => {
      ...
      expect(apiClient.put).toHaveBeenCalledWith('/api/users/user-1', { first_name: 'Alicia' });
    ...
    it('should throw on unauthorized', async () => {
      ...
      await expect(updateProfile('user-1', { first_name: 'X' }))
