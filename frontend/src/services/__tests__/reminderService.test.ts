...
describe('reminderService', () => {
  ...
  describe('createReminder', () => {
    ...
    it('should throw on API error', async () => {
      ...
      await expect(createReminder({ title: 'X', scheduled_at: '2026-01-01T00:00:00Z', user_id: 'u-1' }))
  ...
  describe('updateReminder', () => {
    it('should update and return the updated reminder', async () => {
      ...
      expect(apiClient.put).toHaveBeenCalledWith('/api/reminder/reminder-1', { title: 'Updated title' });
    ...
    it('should throw on unauthorized', async () => {
      ...
      await expect(updateReminder('reminder-1', { title: 'X' }))
  ...
  describe('updateReminderStatus', () => {
    it('should update and return the new status', async () => {
      ...
      expect(apiClient.put).toHaveBeenCalledWith('/api/reminder-status/reminder-1', { status: 'Done' });
    ...
    it('should throw on invalid status', async () => {
      ...
      await expect(updateReminderStatus('reminder-1', { status: 'Invalid' }))
