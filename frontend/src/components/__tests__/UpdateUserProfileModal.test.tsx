...
describe('UpdateUserProfileModal', () => {
  ...
  describe('form validation', () => {
    ...
    it('should show error when name exceeds 100 characters', async () => {
      ...
      await waitFor(() => {
        expect(getByText('register.errors.Name must be at most 100 characters')).toBeTruthy();
      });
  ...
  describe('form submission', () => {
    ...
    it('should show loading state during submission', async () => {
      mockOnSave.mockImplementation(() => new Promise(resolve => setTimeout(() => resolve(undefined), 100)));
  ...
  describe('edge cases', () => {
    it('should handle null initialData gracefully', () => {
      ...
      expect(getByPlaceholderText('CreateProfile.placeholders.Enter the profile First Name')).toBeTruthy();
    });
