...
from app.schemas.reminder_status_schema import (
    ReminderStatusCreate, ReminderStatusUpdate
)
...
class TestUserModel:
    ...
    def test_user_birthday_validation_future_date(self):
        ...
        with pytest.raises(
            ValueError, match="Birthday cannot be in the future"
        ):
    ...
    def test_user_birthday_validation_unrealistic_age(self):
        ...
        with pytest.raises(
            ValueError, match="Birthday results in unrealistic age"
        ):
    ...
    def test_user_birthday_invalid_string_format(self):
        ...
        # Invalid formats
        with pytest.raises(
            ValueError, match="Birthday must be in YYYY-MM-DD format"
        ):
    ...
    def test_user_birthday_invalid_type(self):
        ...
        msg = "Birthday must be a date object or string"
    ...
    def test_user_first_name_101_chars(self):
        ...
        msg = "First name is required and must be <= 100 chars"
        with pytest.raises(ValueError, match=msg):
...
class TestCaregiverModel:
    ...
    def test_caregiver_email_validation(self):
        ...
        msg = "email is required and a valid email"
        with pytest.raises(ValueError, match=msg):
    ...
    def test_caregiver_password_validation_requirements(self):
        ...
        # Missing digit
        msg_digit = "Password should have at least one numeral"
        with pytest.raises(ValueError, match=msg_digit):
            caregiver.password = "NoDigits!"

        # Missing uppercase
        msg_upper = "Password should have at least one uppercase"
        with pytest.raises(ValueError, match=msg_upper):
            caregiver.password = "nouppercase123!"

        # Missing lowercase
        msg_lower = "Password should have at least one lowercase"
        with pytest.raises(ValueError, match=msg_lower):
            caregiver.password = "NOLOWERCASE123!"

        # Missing special character
        msg_special = "Password should have at least one of the symbols"
        with pytest.raises(ValueError, match=msg_special):
    ...
    def test_caregiver_password_all_lowercase_no_upper(self):
        ...
        msg = "Password should have at least one uppercase"
        with pytest.raises(ValueError, match=msg):
            caregiver.password = "validpass123!"
    ...
    def test_caregiver_password_all_uppercase_no_lower(self):
        ...
        msg = "Password should have at least one lowercase"
        with pytest.raises(ValueError, match=msg):
            caregiver.password = "VALIDPASS123!"
...
class TestReminderModel:
    ...
    def test_reminder_scheduled_at_invalid_format(self):
        ...
        msg = "scheduled_at must be a valid ISO datetime format"
        with pytest.raises(ValueError, match=msg):
    ...
    def test_reminder_title_201_chars(self):
        ...
        msg = "Title is required and must be <= 200 chars"
        with pytest.raises(ValueError, match=msg):
    ...
    def test_reminder_scheduled_at_invalid_type(self):
        ...
        err_msg = "scheduled_at must be a datetime object or ISO string"
...
class TestReminderStatusModel:
    ...
    def test_reminder_status_exactly_15_chars(self):
        """Test status with exactly 15 characters (boundary)."""
        status = ReminderStatusModel()
        status_15 = "a" * 15
    ...
    def test_reminder_status_very_long_status(self):
        ...
        msg = "status is required and must be <= 200 chars"
        with pytest.raises(ValueError, match=msg):
...
class TestEdgeCases:
    ...
    def test_reminder_scheduled_at_past_date(self):
        """Test reminder with past scheduled date."""
        reminder = ReminderModel()
...
def test_summary():
    ...
    print("  ✓ Password security (length, cases, digit, special)")
