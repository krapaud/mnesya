...
TEST_DATABASE_URL = os.getenv(
    "TEST_DATABASE_URL", "postgresql://mnesya_user:changeme@db:5432/mnesya_test_db"
)
...
def sample_user_data():
    ...
    return {"first_name": "John", "last_name": "Smith", "birthday": "1950-05-15"}
...
def create_test_reminder(db_session):
    ...
    def _create_reminder(caregiver_id=None, user_id=None, scheduled_at=None):
        ...
        reminder.scheduled_at = scheduled_at or datetime.now(timezone.utc) + timedelta(
            days=1
        )
