...
class TestCreateUserProfile:
    ...
    def test_create_profile_success(self, authenticated_client, sample_user_data):
...
class TestGetAllUserProfiles:
    ...
    def test_get_all_profiles_with_users(self, authenticated_client, create_test_user):
    ...
    def test_get_all_profiles_only_own(self, authenticated_client, create_test_user, create_test_caregiver):
...
class TestGetSpecificUserProfile:
    ...
    def test_get_profile_unauthorized(self, authenticated_client, create_test_user, create_test_caregiver):
    ...
    def test_get_profile_without_auth(self, client, create_test_user, create_test_caregiver):
...
class TestUpdateUserProfile:
    ...
    def test_update_multiple_fields(self, authenticated_client, create_test_user):
    ...
    def test_update_unauthorized(self, authenticated_client, create_test_user, create_test_caregiver):
    ...
    def test_update_without_auth(self, client, create_test_user, create_test_caregiver):
...
class TestDeleteUserProfile:
    ...
    def test_delete_profile_success(self, authenticated_client, create_test_user, db_session):
    ...
    def test_delete_profile_unauthorized(self, authenticated_client, create_test_user, create_test_caregiver):
    ...
    def test_delete_profile_without_auth(self, client, create_test_user, create_test_caregiver):
    ...
    def test_delete_profile_cascades(self, authenticated_client, create_test_user, db_session):
